...
<section class="sh-landing-intro landing-big-background devops">
...
<section class="sh-dark-band">
    <div class="modern-information-structure">
        <div class="mis-child">
            <h2 class="large-h2 align-left">Gain a trusted Partner <br/> For Microsoft Azure</h2>
        </div>
        ...
        <div class="mis-child align-left">
            <div class="row-container">
                <div class="service-container">
                    <div>
                        <h2 class="large-h2">Cost <br/>Effectiveness</h2>
                        <h4 class="impact-h4">Identify wasteful spending and <strong>save money.</strong></h4>
                    </div>
                    <img class="visible-md" style="max-width: 100%;" src="/images/cost.svg" alt="Risk Management" />
                    <p>
                ...
                <div class="img-service-container right hidden-md">
                    <img style="width: 100%" src="/images/cost.svg" alt="Risk Management" />
                </div>
            </div>
        </div>
        <div class="mis-child align-right">
            <div class="row-container">
                <div class="img-service-container left hidden-md">
                    <img style="width: 100%" src="/images/stability.svg" alt="Innovation and Ideation" />
                </div>
                <div class="service-container">
                    <div>
                        <h2 class="large-h2 align-right">Stability <br/>and Reliability</h2>
                        <h4 class="impact-h4 align-right"><strong>Proactive monitoring</strong> and <strong>stable deployments.</strong></h4>
                    </div>
                    <img class="visible-md" style="max-width: 100%;" src="/images/stability.svg" alt="Innovation and Ideation" />
                    <p>
